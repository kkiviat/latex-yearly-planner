...
func Annual(cfg config.Config, tpls []string) (page.Modules, error) {
	...
	return page.Modules{{
		...
		Body: map[string]interface{}{
			...
			"Extra2": extra2(cfg.ClearTopRightCorner, true, false, nil, nil, 0),
		},
	}}, nil
}

func extra2(ctrc, sel1, sel2 bool, week *cal.Week, other *header.CellItem, idxPage int) header.Items {
